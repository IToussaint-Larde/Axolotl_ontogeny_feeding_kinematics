#################################################################################
#                                                                               #
# EXTRACTION of suction feeding kinematics data from a DeeLabCut .CSV file      #
#                                                                               #
#################################################################################
...
# Thd1, Mhd1, TMhd1, Dhd1, MShd1down,  #
# MAhd1down, MShd1up, MAhd1up          #
#                                      #
########################################
...
# MShd1down # max hyoid1 speed when depressing
MShd1down <- max(interval_T0_hd1_Tmax_hd1$hyoid1_speed, na.rm = TRUE)  
# MAhd1down # max hyoid1 accelertion when depressing
MAhd1down <- max(interval_T0_hd1_Tmax_hd1$hyoid1_acceleration, na.rm = TRUE) 
# MShd1up # max hyoid1 speed when going back to initial position
MShd1up <- min(interval_Tmax_hd1_Tend_hd1$hyoid1_speed, na.rm = TRUE)  
#MAhd1up # max hyoid1 acceleration when going back to initial position
MAhd1up <- max(interval_Tmax_hd1_Tend_hd1$hyoid1_acceleration, na.rm = TRUE) 
...
# Thd2, Mhd2, TMhd2, Dhd2, MShd2down,  #
